...
public class Sight : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        for (i = 0; i < colliders.Length; i++)
        {
            ...
            Vector3 directioToController = Vector3.Normalize(collider.bounds.center - transform.position);

            float angleToCollider = Vector3.Angle(transform.forward, directioToController);
